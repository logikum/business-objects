...
describe('Property context', function() {
  ...
  var ctx = new PropertyContext(properties, getValue, setValue);
  ...
  it('constructor expects zero-three arguments', function() {
    ...
    function create03() { return new PropertyContext('1', '2', '3'); }
    ...
    function create07() { return new PropertyContext(properties); }
    function create08() { return new PropertyContext(properties, getValue); }
    function create09() { return new PropertyContext(properties, undefined, setValue); }
    function create10() { return new PropertyContext(properties, getValue, setValue); }
