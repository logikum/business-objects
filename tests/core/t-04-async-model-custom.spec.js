...
var BlanketOrder = require('../../data/custom-core/async-models/blanket-order.js');
var BlanketOrderView = require('../../data/custom-core/async-models/blanket-order-view.js');
var BlanketOrderList = require('../../data/custom-core/async-models/blanket-order-list.js');
...
describe('Asynchronous data portal method', function () {
  ...
  it('fetch of custom read-only model', function (done) {
    ...
    BlanketOrderView.get( 4, ehBlanketOrderView )
  ...
  it('fetch of custom read-only collection', function (done) {
    ...
    .then( function( orderList ) {
      ...
      expect(orderListItem.orderCode).toBe('100');
      ...
      function write2 () { orderListItem.orderCode = '10001'; }
  ...
  it('update of custom editable model', function (done) {
    console.log('\n*** Asynchronous SAVE');

    BlanketOrder.get( 4, ehBlanketOrder )
    .then( function( order ) {
  ...
  it('delete of custom editable model', function (done) {
    console.log('\n*** Asynchronous REMOVE');
