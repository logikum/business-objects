...
var BlanketOrders = require('../../data/simple-core/async/blanket-orders.js');
var BlanketOrderChild = require('../../data/simple-core/async/blanket-order-child.js');
  ...
  it( 'update of sample editable collection', done => {
    ...
    .then( list => {
      ...
      .then( orders => {
        ...
        expect(schedule3.orderScheduleKey).toBe(22);
        expect(schedule3.orderItemKey).toBe(17);
