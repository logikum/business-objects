...
var BlanketOrder = require('../../data/simple-core/blanket-order.js');
var BlanketOrderView = require('../../data/simple-core/blanket-order-view.js');
var BlanketOrderList = require('../../data/simple-core/blanket-order-list.js');
...
describe('Data portal method', () => {
  ...
  it( 'GET of simple read-only model', done => {
    console.log( '\n*** Method GET' );
