...
var BlanketOrders = require('../../data/simple-core/sync/blanket-orders.js');
var BlanketOrderChild = require('../../data/simple-core/sync/blanket-order-child.js');
...
describe('Synchronous data portal method', function () {
  ...
  it('create of sample editable collection', function () {
    console.log('\n*** Synchronous collection CREATE');

    console.log('    < Create order collection >');
    var orders = BlanketOrders.create(ehBlanketOrders);

    //region Load data

    console.log('    < Create order #1 >');
    var order1 = orders.createItem();
    ...
    var item1 = order1.items.createItem();
    ...
    var item2 = order1.items.createItem();
    ...
    var schedule1 = item1.schedules.createItem();
    ...
    var schedule2 = item1.schedules.createItem();
    ...
    var item3 = order2.items.createItem();
    ...
    expect(item2.orderItemKey).toBe(27);
    ...
    expect(schedule1.orderScheduleKey).toBe(34);
    ...
    expect(schedule2.orderScheduleKey).toBe(35);
    ...
    expect(order2.orderKey).toBe(10);
    ...
    expect(address2.addressKey).toBe(10);
    expect(address2.orderKey).toBe(10);
    ...
    expect(item3.orderItemKey).toBe(28);
    expect(item3.orderKey).toBe(10);
    ...
    expect(schedule3.orderScheduleKey).toBe(36);
    expect(schedule3.orderItemKey).toBe(28);
  ...
  it('update of sample editable collection', function () {
    console.log('\n*** Synchronous collection UPDATE');

    console.log('    < Fetch order collection >');
    var orders = BlanketOrders.getFromTo(9, 10, ehBlanketOrders);
    ...
    var item3 = order1.items.createItem();
    ...
    var schedule3 = item1.schedules.createItem();
    ...
    var item4 = order3.items.createItem();
    ...
    var schedule5 = item4.schedules.createItem();
  ...
  it('delete of sample editable collection', function () {
    console.log('\n*** Synchronous collection REMOVE');

    console.log('    < Fetch order collection >');
    var orders = BlanketOrders.getFromTo(9, 11, ehBlanketOrders);
    ...
    var exOrders = BlanketOrders.getFromTo(9, 11, ehBlanketOrders);
