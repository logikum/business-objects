...
describe( 'Is-in-all-roles rule', () => {
  ...
  it( 'constructor expects three-to-six arguments', () => {
    ...
    expect( build03 ).toThrow( 'The roles argument of IsInAllRolesRule constructor must be an array of String values or a single String values.' );
  ...
  it( 'execute method works', () => {
    ...
    expect( call04 ).toThrow( 'The userInfo argument of IsInAllRolesRule.execute method must be a UserInfo object or null.' );
